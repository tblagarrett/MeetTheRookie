...
namespace Yarn.Unity.Example
{
    ...
    public class YarnCharacter : MonoBehaviour
    {
        ...
        private Vector3 messageBubbleOffset = new Vector3(0f, 3f, 0f);
        public float additionalOffestY = 1f;
        ...
        void Start()
        {
            ...
            messageBubbleOffset.y= gameObject.GetComponent<SpriteRenderer>().bounds.size.y/2 + additionalOffestY;
